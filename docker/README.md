...
official/supported Docker Images found at https://hub.docker.com/r/helleniccoinpay/helleniccoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/helleniccoinpay/helleniccoind-develop/ when changing the above text**
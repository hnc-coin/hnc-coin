...
EXPECTED_HOLDER_NAMES = [
    ...
    "The HellenicCoin Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a HellenicCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The HellenicCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of HellenicCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the HellenicCoin Core repository.
"""

...
from test_framework.test_framework import HellenicCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(HellenicCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as HellenicCoinTestFramework doesn't support this atm)

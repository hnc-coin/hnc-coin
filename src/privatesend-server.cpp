...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all HellenicCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat HellenicCoin and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all HellenicCoin specific functionality

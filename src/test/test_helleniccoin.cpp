...
#define BOOST_TEST_MODULE HellenicCoin Test Suite

#include "test_helleniccoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_helleniccoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner HellenicCoin address\n"
            "  payee          - Print the masternode payout HellenicCoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting HellenicCoin address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_1000000);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "helleniccoin",               "masternode",             &masternode,             true,  {} },
    { "helleniccoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "helleniccoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "helleniccoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

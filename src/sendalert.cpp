...
2. run helleniccoind with -printalert or -sendalert like this:
   /path/to/helleniccoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.helleniccoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/HellenicCoin Core:0.12.0.58/"));

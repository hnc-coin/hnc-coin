...
/** Class encapsulating HellenicCoin Core startup and shutdown.
...
/** Main HellenicCoin application object */
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // helleniccoin: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. HellenicCoin Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(helleniccoin);
    Q_INIT_RESOURCE(helleniccoin_locale);
    ...
    /// 6. Determine availability of data directory and parse helleniccoin.conf
    ...
    // helleniccoin: links repeatedly have their payment requests routed to this process:

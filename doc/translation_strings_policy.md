...
This document provides guidelines for internationalization of the HellenicCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `helleniccoin_en.ts` remains unchanged.

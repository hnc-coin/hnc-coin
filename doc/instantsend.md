...
This mechanism has been integrated into Bitcore-Node-HellenicCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/helleniccoinpay/insight-api-helleniccoin#web-socket-api](https://github.com/helleniccoinpay/insight-api-helleniccoin#web-socket-api)
* API: [https://github.com/helleniccoinpay/insight-api-helleniccoin#instantsend-transactions](https://github.com/helleniccoinpay/insight-api-helleniccoin#instantsend-transactions)
